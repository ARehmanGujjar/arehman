...
const Portfolio = () => {
  return (
    <>
    <div className="bg-[#141A4C] p-4 min-h-screen m-1 rounded-lg">
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
    <div className="md:w-2/3 lg:w-1/2 mt-12 text-gray-100">
      ...
      <h2 className="my-8 text-2xl font-bold text-white md:text-4xl">Projects</h2>
      <p className="text-gray-300">Here are some projects which I used to built during learning</p>
    </div>
    <div
...
//  bg-gray-800 transition hover:z-[1] hover:shadow-2xl  hover:shadow-gray-600/10